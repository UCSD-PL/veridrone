      ...
      * apply and_left1.
        { apply and_right; repeat apply or_left; try apply imp_right;
          ...
          - apply imp_strengthen with (F2:="h" < ubH);
            ...
            + rewrite H8 in H9. clear H8 H0 H1 H5 H7 H10 H6.
              unfold amax. repeat rewrite Rplus_assoc.
              match goal with
          ...
          - apply imp_strengthen with (F2:="h" < ubH);
            ...
            + repeat rewrite Rplus_assoc.
              ...
              Time solve_nonlinear.
            + assert (hd tr "v" <= vt + 2 * d)%R by admit.
              Time solve_nonlinear.
          - apply imp_strengthen with (F2:="v" < --vt + ubV);
              [ solve_linear | ].
            solve_linear;
          ...
          - solve_linear;
            ...
            + rewrite H6 in H7.
              ...
              * unfold amax in *. Time solve_nonlinear.
