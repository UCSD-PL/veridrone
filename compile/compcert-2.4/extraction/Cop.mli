...
val sem_add : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option
...
val sem_sub : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option

val sem_mul : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option

val sem_div : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option

val sem_mod : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option

val sem_and : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option

val sem_or : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option

val sem_xor : coq_val -> coq_type -> coq_val -> coq_type -> coq_val option
