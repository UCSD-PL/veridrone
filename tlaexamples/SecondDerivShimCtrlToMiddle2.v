...
*)
  ...
  Proof.
    ...
    specialize
      (H10 ((Stream.hd tr) "T" - (Stream.hd tr) "t"))%R.
    destruct (Rle_dec R0
                      ((Stream.hd tr) "V"+
                       (Stream.hd tr) "a"*
        ...
        - simpl deriv_formula. restoreAbstraction.
          ...
          { charge_intros; repeat charge_split;
            ...
            { eapply zero_deriv with (x:="a");
              ...
              solve_linear; rewrite_next_st;
              solve_linear. } }
          { solve_linear. rewrite H7. rewrite H8. rewrite H9.
            solve_linear. }
          { charge_intros; repeat charge_split;
            charge_intros.
            { eapply zero_deriv with (x:="a");
        ...
        { tlaAssert ("a"! <= 0 \\// "a"! >= 0);
          ...
          - simpl. restoreAbstraction. charge_intros.
            ...
            +
              ...
              specialize (H9 (Stream.hd tr "T" - Stream.hd tr "t")%R indInvPremise).
              pose proof indInvPremise2 as indInvPremise2.
              specialize (indInvPremise2  (Stream.hd tr "t") (Stream.hd tr "T") H8 H12 H7).
  ...
  *)              
        ...
        }
        {
          ...
          [ solve_linear | charge_intros; decompose_hyps ].
          {
            ...
            pose proof indInvPremise2 as indInvPremise2.
            specialize (indInvPremise2  (Stream.hd tr "t") (Stream.hd tr "T") H6 H10 H5).
            destruct (Rge_dec ( Stream.hd tr "V" + Stream.hd tr "a" * (Stream.hd tr "T" - Stream.hd tr "t")) R0).
            {
              apply Rge_le in r.
